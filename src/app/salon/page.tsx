...
const MUSICA = "https://images.unsplash.com/photo-1493676304819-0d7a8d026dcf?w=1600&q=75";
...
const SLIDES = [
  ...
  { src: MUSICA, type: "Recitales & Shows" },
...
const EVENT_TYPES = [
  ...
  { tag: "Música", title: "Música & Recitales", desc: "Shows en vivo, recitales y fiestas electrónicas con sonido de alta potencia.", src: MUSICA },
...
const GALLERY = [
  ...
  { src: MUSICA, caption: "Fiesta electrónica" },
];

/* ─── Próximos eventos (diversos) ─── */
const EVENTS = [
  { title: "EXPO AUTOS CÓRDOBA", type: "Expo", day: "12", month: "JUN", info: "Salón del automóvil · 3 días", src: img("expo-autos.jpg"), accent: false, featured: true },
  { title: "CONGRESO MÉDICO PROVINCIAL", type: "Congreso", day: "19", month: "JUN", info: "+1.500 asistentes", src: img("congreso-multitud.jpg"), accent: false, featured: false },
  { title: "FERIA METALMECÁNICA", type: "Feria", day: "26", month: "JUN", info: "Industria & tecnología", src: img("feria-metal.jpg"), accent: false, featured: false },
  { title: "NOCHE DE GALA SOLIDARIA", type: "Gala", day: "5", month: "JUL", info: "Cena & show en vivo", src: img("gala-mesas.jpg"), accent: false, featured: false },
  { title: "RESONANCE", type: "Música", day: "12", month: "JUL", info: "Techno · fiesta electrónica", src: MUSICA, accent: true, featured: false },
  { title: "FERIA DEL EMPRENDEDOR", type: "Feria", day: "19", month: "JUL", info: "Networking & stands", src: img("feria-stands.jpg"), accent: false, featured: false },
];
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <Reveal delay={0.1}><h2 className="font-[family-name:var(--font-heading)] text-3xl font-bold leading-tight text-[#1D1D1B] sm:text-5xl">Próximos eventos</h2></Reveal>
          </div>
          <Reveal delay={0.15}><p className="max-w-xs text-sm text-[#4f4f4f]">Congresos, ferias, expos y shows. Todo pasa en FORJA.</p></Reveal>
        </div>
          ...
          <div className="group mt-12 overflow-hidden rounded-2xl border border-black/5 bg-[#f4f4f3] transition-shadow duration-500 hover:shadow-xl hover:shadow-black/10">
            <div className="grid md:grid-cols-2">
              ...
              <div className="flex flex-col justify-center p-7 sm:p-10">
                <div className="flex items-center gap-3 text-[#4f4f4f]">
                  <span className="font-[family-name:var(--font-heading)] text-2xl font-bold text-[#E21F17]">{featured.day}</span>
                  <span className="text-sm uppercase tracking-wider">{featured.month}</span>
                </div>
                <h3 className="mt-3 font-[family-name:var(--font-heading)] text-3xl font-bold text-[#1D1D1B] sm:text-4xl">{featured.title}</h3>
            ...
            <Reveal key={e.title} delay={0.05 * i}>
              <div className="group overflow-hidden rounded-xl border border-black/5 bg-[#f4f4f3] transition-all duration-500 hover:-translate-y-1.5 hover:shadow-lg hover:shadow-black/10">
                <div className="relative aspect-[16/10] overflow-hidden">
                  ...
                  <div className="absolute right-3 top-3 flex flex-col items-center rounded-lg bg-[#1D1D1B]/85 px-2.5 py-1.5 backdrop-blur-sm">
                    <span className="font-[family-name:var(--font-heading)] text-lg font-bold leading-none text-white">{e.day}</span>
                    <span className="text-[9px] uppercase tracking-wider text-white/80">{e.month}</span>
                  </div>
                </div>
                <div className="p-5">
